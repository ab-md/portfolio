...
const projects = [
  {
    ...
    techs: ["React", "CSS", "JavaScript", "Bootstrap", "Redux"],
  ...
  },
  {
    ...
    desc: "داشبورد مدیریت کاربران با قابلیت نمایش اطلاعات، مدیریت داده‌ها و طراحی ریسپانسیو با استفاده از Next.js",
    ...
    <section ref={containerRef} className="px-6 md:px-16 py-14 md:py-24">
      <div className="text-center max-w-[560px] mx-auto mb-12 md:mb-14">
        ...
        <p className="text-ink-dim text-[15px]">
          نمونه‌ای از پروژه‌هایی که برای یادگیری، تمرین و توسعه مهارت‌هایم طراحی و پیاده‌سازی کرده‌ام.
        </p>
      </div>
